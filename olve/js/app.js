(() => {
    ...
    function initSliders() {
        if (document.querySelector(".swiper-satisfied")) new swiper_core_Swiper(".swiper-satisfied", {
            modules: [ Navigation ],
            observer: true,
            observeParents: true,
            slidesPerView: 1,
        ...
        if (document.querySelector(".swiper-defending")) new swiper_core_Swiper(".swiper-defending", {
            modules: [ Navigation ],
            observer: true,
            observeParents: true,
            slidesPerView: 1,
