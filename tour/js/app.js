(() => {
    ...
    (() => {
        ...
        if (document.querySelector(".calendar-content-product__input")) {
            const pickerMain = datepicker_min(".calendar-content-product__input", {
                alwaysShow: true,
                customDays: [ "M", "T", "W", "T", "F", "S", "S" ],
                customMonths: [ "January", "February", "March", "April", "May", "June", "July", "August", "September", "October", "November", "December" ]
            });
            if (!modules_flsModules.datepickers) modules_flsModules.datepickers = [];
            modules_flsModules.datepickers.push(pickerMain);
        }
        document.querySelectorAll("[data-datepicker]").forEach((datepickerElement => {
            if (!datepickerElement.matches(".calendar-content-product__input")) {
                const picker = datepicker_min(datepickerElement, {
                    customDays: [ "M", "T", "W", "T", "F", "S", "S" ],
                    customMonths: [ "January", "February", "March", "April", "May", "June", "July", "August", "September", "October", "November", "December" ],
        ...
        swiper_core_Swiper.use([ Navigation, Thumb ]);
        function initSliders() {
            if (document.querySelector(".swiper-packages")) new swiper_core_Swiper(".swiper-packages", {
                modules: [ Navigation ],
                observer: true,
                observeParents: true,
                slidesPerView: 1,
            ...
            if (document.querySelector(".swiper-rewies")) new swiper_core_Swiper(".swiper-rewies", {
                modules: [ Navigation ],
                observer: true,
                observeParents: true,
                slidesPerView: 1,
            ...
            let sliderMini;
            if (document.querySelector(".previews-slider-product")) sliderMini = new swiper_core_Swiper(".previews-slider-product", {
                modules: [ Thumb ],
                slidesPerView: 3,
                spaceBetween: 12,
                freeMode: true,
            ...
            if (document.querySelector(".main-slider-product")) if (sliderMini) {
                new swiper_core_Swiper(".main-slider-product", {
                    modules: [ Thumb ],
                    spaceBetween: 20,
                    thumbs: {
                        swiper: sliderMini
                    ...
                    navigation: {
                        nextEl: ".main-slider-product--prev",
                        prevEl: ".main-slider-product--next"
                    },
                    pagination: {
                        el: ".swiper-pagination",
                        clickable: true
        ...
        function windowLoaded() {
            let documentActions = e => {
                ...
                if (targetElement.closest(".language-header")) {
                    if (targetTag !== "A") {
                        const contactsHeader = targetElement.closest(".language-header");
                        contactsHeader.classList.toggle("--active");
                    }
                } else document.querySelector(".language-header").classList.remove("--active");
            };
