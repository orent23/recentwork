(() => {
    ...
    function initSliders() {
        ...
        if (document.querySelector(".swiper-love")) new swiper_core_Swiper(".swiper-love", {
            modules: [ Navigation ],
            observer: true,
            observeParents: true,
            slidesPerView: 1,
        ...
        if (document.querySelector(".swiper-explore")) new swiper_core_Swiper(".swiper-explore", {
            modules: [ Navigation ],
            observer: true,
            observeParents: true,
            slidesPerView: 1,
        ...
        const defaultIconColor = "purpur";
        const defaultBackgroundColor = "white";
        function changeButtonColor(button, iconColor, backgroundColor, iconClass) {
            const icon = button.querySelector(`svg.${iconClass}`);
            if (icon) icon.style.fill = iconColor;
            button.style.backgroundColor = backgroundColor;
            setTimeout((function() {
                if (icon) icon.style.fill = defaultIconColor;
                button.style.backgroundColor = defaultBackgroundColor;
            }), 500);
        }
        const prevButtonExplore = document.querySelector(".swiper-button-prev.explore__arrow");
        const nextButtonExplore = document.querySelector(".swiper-button-next.explore__arrow");
        const prevButtonLove = document.querySelector(".swiper-button-prev.love__arrow");
        const nextButtonLove = document.querySelector(".swiper-button-next.love__arrow");
        if (prevButtonExplore) prevButtonExplore.addEventListener("click", (function() {
            changeButtonColor(prevButtonExplore, "red", "#FFCE4E", "explore__image");
        }));
        if (nextButtonExplore) nextButtonExplore.addEventListener("click", (function() {
            changeButtonColor(nextButtonExplore, "blue", "#FFCE4E", "explore__image");
        }));
        if (prevButtonLove) prevButtonLove.addEventListener("click", (function() {
            changeButtonColor(prevButtonLove, "red", "#FFCE4E", "love__icon");
        }));
        if (nextButtonLove) nextButtonLove.addEventListener("click", (function() {
            changeButtonColor(nextButtonLove, "blue", "#FFCE4E", "love__icon");
        }));
    }
    initSliders();
    window.addEventListener("load", (function(e) {
